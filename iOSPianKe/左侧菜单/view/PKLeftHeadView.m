...
- (UIButton *)userNameBtn{
    if (!_userNameBtn) {
        ...
        _userNameBtn.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;//左对齐文字
    }
    return _userNameBtn;
}
...
-(UIImageView *)image
{
    if (!_image)
    {
        _image = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"侧边头部背景.jpg"]];
    }
    return _image;
}
@end
